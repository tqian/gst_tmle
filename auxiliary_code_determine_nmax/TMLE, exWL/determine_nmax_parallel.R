...
save(test, file = paste0("Result/nmax_H1exWL_enrollrate", v$enrollrate, "_", iter, "_", version_fut, ".rda"))

v$randomA <- TRUE

test <- simtrials(dt, v)
save(test, file = paste0("Result/nmax_H0exWL_enrollrate", v$enrollrate, "_", iter, "_", version_fut, ".rda"))