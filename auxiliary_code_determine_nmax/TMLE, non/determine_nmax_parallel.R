...
save(test, file = paste0("Result/nmax_H1_enrollrate", v$enrollrate, "_", iter, "_", version_fut, ".rda"))

v$randomA <- TRUE

test <- simtrials(dt, v)
save(test, file = paste0("Result/nmax_H0_enrollrate", v$enrollrate, "_", iter, "_", version_fut, ".rda"))